...
@SuppressWarnings({"WeakerAccess", "unused"}) public class LottieAnimationNativeView extends AppCompatImageView {

  private static final String TAG = LottieAnimationNativeView.class.getSimpleName();
  ...
  private static class WeakSuccessListener implements LottieListener<LottieComposition> {
    ...
    private final WeakReference<LottieAnimationNativeView> targetReference;

    public WeakSuccessListener(LottieAnimationNativeView target) {
      this.targetReference = new WeakReference<>(target);
    }

    @Override public void onResult(LottieComposition result) {
      LottieAnimationNativeView targetView = targetReference.get();
      if (targetView == null) {
        return;
      }
  ...
  private static class WeakFailureListener implements LottieListener<Throwable> {
    ...
    public WeakFailureListener(LottieAnimationNativeView target) {
      this.targetReference = new WeakReference<>(target);
    }
  ...
  public LottieAnimationNativeView(Context context) {
    super(context);
    init(null, R.attr.lottieAnimationViewStyle);
  }

  public LottieAnimationNativeView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(attrs, R.attr.lottieAnimationViewStyle);
  }

  public LottieAnimationNativeView(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  private static class SavedState extends BaseSavedState {
    ...
    public static final Creator<SavedState> CREATOR =
        new Creator<LottieAnimationNativeView.SavedState>() {
          @Override
          public LottieAnimationNativeView.SavedState createFromParcel(Parcel in) {
            return new LottieAnimationNativeView.SavedState(in);
          }

          @Override
          public LottieAnimationNativeView.SavedState[] newArray(int size) {
            return new LottieAnimationNativeView.SavedState[size];
          }
        };
  }
